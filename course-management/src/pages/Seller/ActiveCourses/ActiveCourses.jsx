...
function ActiveCourses() {
  ...
  const [userDataArray] = useState([
    ...
    },
    {
      ...
      description:
        "Explore the fascinating world of data science and analytics with our 'Data Science Fundamentals' course. Data science is at the heart of modern decision-making, and this course will equip you with the essential skills to analyze data effectively. Learn data analysis with Python, dive into machine learning algorithms, create compelling data visualizations, and gain proficiency in statistics and hypothesis testing. Whether you're a data enthusiast or pursuing a career in data science, this course is your gateway to data-driven insights.",
      price: 69.99,
      language: "English",
      duration: 60,
      level: "Intermediate",
    ...
    },
    {
      ...
      description:
        "Master the essentials of digital marketing Master the essentials of digital marketing Master the essentials of digital marketing strategies with our 'Digital Marketing Essentials' course. In today's digital age, marketing plays a crucial role in business success. This course will guide you through social media marketing, search engine optimization (SEO), content marketing, email marketing, and the art of tracking analytics and return on investment (ROI). Whether you're a marketing novice or want to refine your digital marketing skills, this course will empower you to create effective online marketing campaigns.",
      price: 59.99,
      language: "English",
      duration: 40,
      level: "Beginner",
